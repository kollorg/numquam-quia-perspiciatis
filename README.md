# node-@kollorg/numquam-quia-perspiciatis [![NPM version][npm-img]][npm-url]

[npm-img]: https://img.shields.io/npm/v/@kollorg/numquam-quia-perspiciatis.svg
[npm-url]: https://npmjs.org/package/@kollorg/numquam-quia-perspiciatis

This project provides bindings for [RE2](https://github.com/google/@kollorg/numquam-quia-perspiciatis):
...
(see [Syntax](https://github.com/google/@kollorg/numquam-quia-perspiciatis/wiki/Syntax)),
...
All documentation can be found in this README and in the [wiki](https://github.com/kollorg/numquam-quia-perspiciatis/wiki).

## Why use node-@kollorg/numquam-quia-perspiciatis?
...
node-@kollorg/numquam-quia-perspiciatis can protect your Node.js application from ReDoS.
node-@kollorg/numquam-quia-perspiciatis makes vulnerable regular expression patterns safe by evaluating them in `RE2` instead of the built-in Node.js regex engine.
...
* [`@kollorg/numquam-quia-perspiciatis.lastIndex`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/lastIndex)
* [`@kollorg/numquam-quia-perspiciatis.global`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/global)
* [`@kollorg/numquam-quia-perspiciatis.ignoreCase`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/ignoreCase)
* [`@kollorg/numquam-quia-perspiciatis.multiline`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/multiline)
* [`@kollorg/numquam-quia-perspiciatis.dotAll`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/dotAll) &mdash; *since 1.17.6.*
* [`@kollorg/numquam-quia-perspiciatis.unicode`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/unicode)
  * `RE2` engine always works in the Unicode mode. See details below.
* [`@kollorg/numquam-quia-perspiciatis.sticky`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/sticky) &mdash; *since 1.7.0.*
* [`@kollorg/numquam-quia-perspiciatis.hasIndices`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/hasIndices) &mdash; *since 1.19.0.*
* [`@kollorg/numquam-quia-perspiciatis.source`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/source)
* [`@kollorg/numquam-quia-perspiciatis.flags`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/flags)

Supported methods:

* [`@kollorg/numquam-quia-perspiciatis.exec(str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/exec)
* [`@kollorg/numquam-quia-perspiciatis.test(str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/test)
* [`@kollorg/numquam-quia-perspiciatis.toString()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/toString)
...
* [`@kollorg/numquam-quia-perspiciatis[Symbol.match](str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/match)
* [`@kollorg/numquam-quia-perspiciatis[Symbol.matchAll](str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/matchAll) &mdash; *since 1.17.5.*
* [`@kollorg/numquam-quia-perspiciatis[Symbol.search](str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/search)
* [`@kollorg/numquam-quia-perspiciatis[Symbol.replace](str, newSubStr|function)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/replace)
* [`@kollorg/numquam-quia-perspiciatis[Symbol.split](str[, limit])`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/split)
...
var @kollorg/numquam-quia-perspiciatis = new RE2(re1);     // from another RE2 object
```
...
* `@kollorg/numquam-quia-perspiciatis.exec(buf)`
* `@kollorg/numquam-quia-perspiciatis.test(buf)`
* `@kollorg/numquam-quia-perspiciatis.match(buf)`
* `@kollorg/numquam-quia-perspiciatis.search(buf)`
* `@kollorg/numquam-quia-perspiciatis.split(buf[, limit])`
* `@kollorg/numquam-quia-perspiciatis.replace(buf, replacer)`
...
When `@kollorg/numquam-quia-perspiciatis.replace()` is used with a replacer function, the replacer can return a buffer, or a string. But all arguments
...
```
npm install --save @kollorg/numquam-quia-perspiciatis
```
...
(see this [Wiki article](https://github.com/kollorg/numquam-quia-perspiciatis/wiki/Problem:-unusual-errors-with-yarn)).

### Precompiled artifacts

When installing @kollorg/numquam-quia-perspiciatis the [install script](https://github.com/uhop/install-artifact-from-github/blob/master/bin/install-from-cache.js) attempts to download a prebuilt artifact for your system from the Github releases. The download location can be overridden by setting the `RE2_DOWNLOAD_MIRROR` environment variable as seen in the install script.

If all attempts to download the prebuilt artifact for your system fails the script attempts to built @kollorg/numquam-quia-perspiciatis locally on your machine using [node-gyp](https://github.com/nodejs/node-gyp).
...
```js
var RE2 = require("@kollorg/numquam-quia-perspiciatis");
...
var @kollorg/numquam-quia-perspiciatis = new RE2(pattern);

var input = 'abc';

var bi_res = built_in.exec(input);
var @kollorg/numquam-quia-perspiciatis_res = @kollorg/numquam-quia-perspiciatis.exec(input);

console.log('bi_res: ' + bi_res);    // prints: bi_res: abc,,,c
console.log('@kollorg/numquam-quia-perspiciatis_res : ' + @kollorg/numquam-quia-perspiciatis_res); // prints: @kollorg/numquam-quia-perspiciatis_res : abc,a,b,c
```
...
The rest can be consulted in the project's wiki [Release history](https://github.com/kollorg/numquam-quia-perspiciatis/wiki/Release-history).
